    ...
    <div className="p-4 sm:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-2xl shadow-md p-6 flex items-center gap-4 hover:shadow-xl hover:scale-105 transition-transform duration-300">
          <FaChartLine className="text-indigo-600 text-3xl sm:text-4xl" />
          <div>
            <p className="text-gray-500 text-sm sm:text-base">Total Sales</p>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 flex items-center gap-4 hover:shadow-xl hover:scale-105 transition-transform duration-300">
          ...
          <div>
            <p className="text-gray-500 text-sm sm:text-base">New Users</p>
            <p className="text-xl sm:text-2xl font-bold text-gray-800">1,245</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl shadow-md p-6 flex items-center gap-4 hover:shadow-xl hover:scale-105 transition-transform duration-300">
          <FaTasks className="text-purple-600 text-3xl sm:text-4xl" />
          <div>
            <p className="text-gray-500 text-sm sm:text-base">Tasks Completed</p>
            <p className="text-xl sm:text-2xl font-bold text-gray-800">325</p>
          </div>
        </div>
      </div>
